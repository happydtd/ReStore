...
import { AlertTitle, Paper , List, ListItem, ListItemText, Alert} from '@mui/material';
          ...
          <Box component="form" 
            ...
            <TextField
              ...
              {...register('email',
                  ...
                  pattern:{ value: /^\w+[\w-\.]*\@\w+((-\w+)|(\w*))\.[a-z]{2,3}$/,
                            message:'Not a valid email address'
              }})}
              error={!! errors.email} //if error of username exist return true
            ...
            //   value ={values.password}
              {...register('password', {required: 'Password is required' ,
                      pattern:{ value: /(?=^.{6,10}$)(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&amp;*()_+}{&quot;:;'?/&gt;.&lt;,])(?!.*\s).*$/,
